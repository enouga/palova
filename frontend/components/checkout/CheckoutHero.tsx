    ...
    >
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 10 }}>
        <span style={{
          ...
          fontSize: 12, color: th.text, background: 'rgba(255,255,255,0.65)', borderRadius: 999, padding: '5px 11px',
        }}>
        ...
        {phase !== 'error' && (
          <span style={{
            ...
            fontSize: 12.5, color: urgent ? ACCENTS.coral : th.text, background: '#fff', borderRadius: 999,
      ...
      <div style={{ fontFamily: th.fontDisplay, fontSize: 21, fontWeight: 700, letterSpacing: -0.4, color: th.text, marginTop: 14 }}>
        {resourceName ?? 'Court'}
      </div>
      <div style={{ fontFamily: th.fontUI, fontSize: 14, fontWeight: 600, color: th.text, opacity: 0.65, marginTop: 4, textTransform: 'capitalize' }}>
        {dateLabel}
      </div>
      <div style={{ fontFamily: th.fontUI, fontSize: 13.5, color: th.text, opacity: 0.65, marginTop: 4, display: 'flex', alignItems: 'center', gap: 7, flexWrap: 'wrap' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginTop: 14, flexWrap: 'wrap' }}>
        <span style={{ fontFamily: th.fontDisplay, fontSize: 28, fontWeight: 800, letterSpacing: -0.9, color: th.text }}>{totalPrice}€</span>
        <span style={{ fontFamily: th.fontUI, fontSize: 12.5, color: th.text, opacity: 0.65 }}>soit {perPerson} € / joueur · {capacity} j.</span>
      </div>
