...
export interface AgendaCardHeaderProps {
  icon: IconName;              // trophy (compétition) / bolt (animation) / whistle (cours)
  ...
  extra?: string | null;       // « 40 € » / « Membres » — suffixe de la ligne de date
...
/**
 * Corps visuel commun des cartes d'agenda : tuile icône teintée, tag + compte à rebours,
 * titre, ligne de date, jauge de remplissage.
 *
 * Rendu en fragment de DEUX enfants flex (tuile puis colonne de contenu) → le parent pose
 * `display:flex; align-items:flex-start; gap:13`.
 *
...
export function AgendaCardHeader({
  icon, accent, tag, title, dateLabel, deadline, now, ratio, places, extra, subtitle, sportLabel,
