...
export function useProfileStyles() {
  ...
  const label: CSSProperties = { fontFamily: th.fontUI, fontSize: 13.5, fontWeight: 600, color: th.textMute };
  const primaryBtn = (busy: boolean): CSSProperties => ({
    ...
    padding: '12px 20px', fontFamily: th.fontUI, fontWeight: 700, fontSize: 15.5,
