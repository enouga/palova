...
export function ConfirmDialog({
  ...
  const { th } = useTheme();
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 95, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
      ...
      <div role="dialog" aria-modal="true" style={{ position: 'relative', width: '100%', maxWidth: 480, margin: '0 auto', background: th.bgElev, borderRadius: '28px 28px 0 0', padding: '12px 20px 36px', boxShadow: '0 -10px 40px rgba(0,0,0,0.3)', animation: 'sp-sheet-in .34s cubic-bezier(.2,.8,.2,1)' }}>
